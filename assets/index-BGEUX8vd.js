...
`,j1=["/images/01.png","/images/03.png","/images/04.png","/images/05.png","/images/06.png","/images/07.png","/images/08.png","/images/09.png"],mE=()=>{const n=C.useMemo(()=>{const o=[];for(let l=0;l<8;l++)o.push({id:l,size:Math.random()*100+80,left:Math.random()*85+5,duration:Math.random()*8+16,delay:Math.random()*15,image:j1[Math.floor(Math.random()*j1.length)],clockwise:Math.random()>.5});return o},[]);return h.jsx(hE,{children:n.map(a=>h.jsx(pE,{src:a.image,alt:"","aria-hidden":"true",$size:a.size,$left:a.left,$duration:a.duration,$delay:a.delay,$clockwise:a.clockwise},a.id))})},gE=Tt`
  0%, 100% {
...
`,B1=T.p`
  ...
  opacity: 0.8;
  line-height: 1.6;
`,qE=()=>{const n=C.useRef(null),a=sr(n,{once:!0,margin:"-100px"}),[o,l]=C.useState(!1),[c,f]=C.useState([!1,!1,!1]),[d,g]=C.useState([!1,!1,!1]),[m,p]=C.useState(0),v=["/images/01.png","/images/03.png","/images/04.png","/images/05.png","/images/06.png","/images/07.png","/images/08.png","/images/09.png"],x=[{number:1,title:"Join a Pool",description:"Subscribe and get placed with other players. The more people join, the bigger the prize.",avatar:"/images/01.png",targetIndex:0},{number:2,title:"Draw Day",description:"Every 3 days, one winner is randomly selected. Guaranteed.",avatar:"/images/03.png",targetIndex:1},{number:3,title:"Win Big",description:"The jackpot equals the number of players. 50,000 players = €50,000 prize.",avatar:"/images/05.png",targetIndex:3}],w=z=>-(z*154),j=()=>{l(!0),f([!0,!0,!0]),g([!1,!1,!1]),setTimeout(()=>{f([!1,!0,!0]),g([!0,!1,!1])},500),setTimeout(()=>{f([!1,!1,!0]),g([!0,!0,!1])},750),setTimeout(()=>{f([!1,!1,!1]),g([!0,!0,!0])},1e3)},$=()=>{l(!1),g([!1,!1,!1])},D={hidden:{},visible:{transition:{staggerChildren:.2}}},L={hidden:{opacity:0,y:50},visible:{opacity:1,y:0,transition:{duration:.6}}},N=(z,O)=>{O.offset.x<-50&&m<x.length-1?p(m+1):O.offset.x>50&&m>0&&p(m-1)};return h.jsx(kE,{id:"how-it-works",ref:n,children:h.jsxs(BE,{onMouseEnter:j,onMouseLeave:$,children:[h.jsx(LE,{initial:{opacity:0,y:30},animate:a?{opacity:1,y:0}:{},transition:{duration:.6},children:"How It Works"}),h.jsx(NE,{as:I.div,variants:D,initial:"hidden",animate:a?"visible":"hidden",children:x.map((z,O)=>h.jsxs(D1,{variants:L,children:[h.jsx($1,{children:d[O]?h.jsx(R1,{initial:{scale:0,opacity:0},animate:{scale:1,opacity:1},transition:{type:"spring",stiffness:300,damping:20},children:"WIN!"}):h.jsxs(z1,{$isSpinning:c[O],$finalPosition:w(z.targetIndex),children:[v.map((K,X)=>h.jsx(rs,{src:K,alt:z.title},X)),v.map((K,X)=>h.jsx(rs,{src:K,alt:z.title},`duplicate-${X}`))]})}),h.jsxs(O1,{children:["Step ",z.number]}),h.jsx(k1,{children:z.title}),h.jsx(B1,{children:z.description})]},z.number))}),h.jsxs(VE,{onTouchStart:j,onTouchEnd:$,children:[h.jsx(_E,{drag:"x",dragConstraints:{left:0,right:0},dragElastic:.2,onDragEnd:N,animate:{x:`-${m*100}%`},transition:{type:"spring",stiffness:300,damping:30},children:x.map((z,O)=>h.jsx(UE,{children:h.jsxs(D1,{as:I.div,initial:{opacity:0,y:30},animate:a?{opacity:1,y:0}:{},transition:{duration:.6,delay:.2},children:[h.jsx($1,{children:d[O]?h.jsx(R1,{initial:{scale:0,opacity:0},animate:{scale:1,opacity:1},transition:{type:"spring",stiffness:300,damping:20},children:"WIN!"}):h.jsxs(z1,{$isSpinning:c[O],$finalPosition:w(z.targetIndex),children:[v.map((K,X)=>h.jsx(rs,{src:K,alt:z.title},X)),v.map((K,X)=>h.jsx(rs,{src:K,alt:z.title},`duplicate-${X}`))]})}),h.jsxs(O1,{children:["Step ",z.number]}),h.jsx(k1,{children:z.title}),h.jsx(B1,{children:z.description})]})},z.number))}),h.jsx(HE,{children:x.map((z,O)=>h.jsx(YE,{$active:m===O,onClick:()=>p(O)},O))})]})]})})},XE=Tt`
...
`,Hb=T.p`
  ...
  opacity: 0.7;
  font-size: 0.95rem;
`,UA=()=>{const{isSignUpModalOpen:n,closeSignUpModal:a,openLoginModal:o,playClick:l,playSuccess:c}=Ai(),[f,d]=C.useState(""),[g,m]=C.useState(""),[p,v]=C.useState(""),[x,w]=C.useState(!1);C.useEffect(()=>{n||(d(""),m(""),v(""),w(!1))},[n]);const j=D=>{D.preventDefault(),c(),w(!0),setTimeout(()=>{a()},2e3)},$=()=>{l(),a(),o()};return h.jsx(en,{children:n&&h.jsx(zb,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},onClick:a,children:h.jsxs(Rb,{initial:{opacity:0,scale:.95,y:20},animate:{opacity:1,scale:1,y:0},exit:{opacity:0,scale:.95,y:20},onClick:D=>D.stopPropagation(),children:[h.jsx(Ob,{onClick:a,children:"×"}),x?h.jsxs(Vb,{initial:{opacity:0,scale:.9},animate:{opacity:1,scale:1},children:[h.jsx(_b,{}),h.jsx(Ub,{children:"Welcome to MoneyPools"}),h.jsx(Hb,{children:"Your account has been created."})]}):h.jsxs(h.Fragment,{children:[h.jsx(kb,{children:"Join the Pool"}),h.jsxs(Bb,{onSubmit:j,children:[h.jsxs(po,{children:[h.jsx(mo,{children:"Email"}),h.jsx(go,{type:"email",placeholder:"you@example.com",value:f,onChange:D=>d(D.target.value),required:!0})]}),h.jsxs(po,{children:[h.jsx(mo,{children:"Password"}),h.jsx(go,{type:"password",placeholder:"Create a password",value:g,onChange:D=>m(D.target.value),required:!0,minLength:8})]}),h.jsxs(po,{children:[h.jsx(mo,{children:"Confirm Password"}),h.jsx(go,{type:"password",placeholder:"Confirm password",value:p,onChange:D=>v(D.target.value),required:!0})]}),h.jsx(Lb,{type:"submit",whileHover:{scale:1.01},whileTap:{scale:.99},children:"Create Account"})]}),h.jsxs(Nb,{children:["Already have an account?"," ",h.jsx("button",{type:"button",onClick:$,children:"Log in"})]})]})]})})})},HA=()=>{const{isLoginModalOpen:n,closeLoginModal:a,openSignUpModal:o,playClick:l,playSuccess:c}=Ai(),[f,d]=C.useState(""),[g,m]=C.useState(""),[p,v]=C.useState(!1);C.useEffect(()=>{n||(d(""),m(""),v(!1))},[n]);const x=j=>{j.preventDefault(),c(),v(!0),setTimeout(()=>{a()},2e3)},w=()=>{l(),a(),o()};return h.jsx(en,{children:n&&h.jsx(zb,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},onClick:a,children:h.jsxs(Rb,{initial:{opacity:0,scale:.95,y:20},animate:{opacity:1,scale:1,y:0},exit:{opacity:0,scale:.95,y:20},onClick:j=>j.stopPropagation(),children:[h.jsx(Ob,{onClick:a,children:"×"}),p?h.jsxs(Vb,{initial:{opacity:0,scale:.9},animate:{opacity:1,scale:1},children:[h.jsx(_b,{}),h.jsx(Ub,{children:"Welcome Back"}),h.jsx(Hb,{children:"Good luck in the next draw."})]}):h.jsxs(h.Fragment,{children:[h.jsx(kb,{children:"Welcome Back"}),h.jsxs(Bb,{onSubmit:x,children:[h.jsxs(po,{children:[h.jsx(mo,{children:"Email"}),h.jsx(go,{type:"email",placeholder:"you@example.com",value:f,onChange:j=>d(j.target.value),required:!0})]}),h.jsxs(po,{children:[h.jsx(mo,{children:"Password"}),h.jsx(go,{type:"password",placeholder:"Enter password",value:g,onChange:j=>m(j.target.value),required:!0})]}),h.jsx(Lb,{type:"submit",whileHover:{scale:1.01},whileTap:{scale:.99},children:"Log In"})]}),h.jsxs(Nb,{children:["New here?"," ",h.jsx("button",{type:"button",onClick:w,children:"Sign up"})]})]})]})})})},Yb=C.createContext(),YA={username:"LuckyMax",avatar:"/images/05.png",level:12,memberSince:"Oct 2025",totalWinnings:0,currentPool:1,drawsParticipated:23,drawsWon:0,subscriptionTier:"Pro",nextBilling:"Feb 15, 2026",ticketMultiplier:1,syndicate:null,referralCode:"LUCKYMAX2025"},GA={jackpot:52847,activePlayers:52847,currentDrawNumber:48},qA=[{id:1,text:"You joined Pool #1",time:"2 days ago",type:"join"},{id:2,text:"Draw #47 completed — Player X won €51,203",time:"3 days ago",type:"draw"},{id:3,text:"You received a ticket from Sarah",time:"5 days ago",type:"gift"}],XA=({children:n})=>{const[a,o]=C.useState(YA),[l,c]=C.useState(GA),[f,d]=C.useState(qA),[g,m]=C.useState([]),[p,v]=C.useState(!1),[x,w]=C.useState(!1),[j,$]=C.useState(!1),[D,L]=C.useState(!1),[N]=C.useState(()=>{const Q=new Date;return Q.setDate(Q.getDate()+2),Q.setHours(20,0,0,0),Q});C.useEffect(()=>{const Q=setInterval(()=>{const U=Math.floor(Math.random()*3)+1;c(F=>({...F,jackpot:F.jackpot+U,activePlayers:F.activePlayers+U}))},3e3);return()=>clearInterval(Q)},[]);const X={player:a,setPlayer:o,pool:l,activity:f,notifications:g,addNotification:Q=>{m(U=>[{id:Date.now(),...Q},...U])},nextDraw:N,calculateOdds:()=>{const Q=l.activePlayers,U=a.ticketMultiplier;return Math.ceil(Q/U)},updateMultiplier:Q=>{o(U=>({...U,ticketMultiplier:Q}))},syndicateModalOpen:p,setSyndicateModalOpen:v,giftModalOpen:x,setGiftModalOpen:w,multiplierModalOpen:j,setMultiplierModalOpen:$,inviteModalOpen:D,setInviteModalOpen:L};return h.jsx(Yb.Provider,{value:X,children:n})},dn=()=>{const n=C.useContext(Yb);if(!n)throw new Error("useDashboard must be used within a DashboardProvider");return n},PA=T.header`
  position: fixed;
  top: 0;
  left: 0;
  right: 0;
...
`,P1=["$","€","¥"],K1=[b.gold,b.coral,b.red,"#FFE566"],Q1=()=>{const{pool:n,player:a,calculateOdds:o}=dn(),[l,c]=C.useState(n.jackpot),[f,d]=C.useState(n.activePlayers),[g,m]=C.useState([]),[p,v]=C.useState(!0),x=C.useCallback(()=>{const D=[];for(let L=0;L<60;L++)D.push({id:Date.now()+L,symbol:P1[Math.floor(Math.random()*P1.length)],x:Math.random()*90+5,y:Math.random()*80+10,size:Math.random()*30+20,duration:Math.random()*1.5+2.5,color:K1[Math.floor(Math.random()*K1.length)]});m(D),setTimeout(()=>m([]),4500)},[]);C.useEffect(()=>{const L=l,N=f,z=n.jackpot-L,O=n.activePlayers-N,K=Date.now(),X=()=>{const Q=Date.now()-K,U=Math.min(Q/500,1),F=1-Math.pow(1-U,3);c(Math.round(L+z*F)),d(Math.round(N+O*F)),U<1&&requestAnimationFrame(X)};requestAnimationFrame(X)},[n.jackpot,n.activePlayers]);const w=D=>new Intl.NumberFormat("en-IE",{style:"currency",currency:"EUR",minimumFractionDigits:0}).format(D),j=D=>D.toLocaleString(),$=o();return h.jsxs(VM,{initial:{opacity:0,scale:.95},animate:{opacity:1,scale:1},transition:{duration:.6,delay:.2},children:[g.map(D=>h.jsx(BM,{$x:D.x,$y:D.y,$size:D.size,$duration:D.duration,$color:D.color,children:D.symbol},D.id)),h.jsxs(_M,{initial:{opacity:0,y:-20},animate:{opacity:1,y:0},transition:{duration:.5,delay:.1},children:[h.jsxs(Gb,{onMouseEnter:x,onClick:()=>{v(!1),x()},children:[h.jsx(en,{children:p&&h.jsx(UM,{initial:{opacity:0,y:10},animate:{opacity:1,y:0},exit:{opacity:0,y:-10},transition:{duration:.3},children:"Click me!"})}),h.jsx(YM,{src:a.avatar,alt:a.username})]}),h.jsx(HM,{children:a.username})]}),h.jsxs(GM,{children:[h.jsx(qM,{children:"Current Jackpot"}),h.jsx(XM,{children:w(l)}),h.jsxs(PM,{children:[h.jsxs(ed,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{delay:.3},children:[h.jsx(nd,{$color:b.coral,children:j(f)}),h.jsx(id,{children:"Active Players"})]}),h.jsxs(ed,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{delay:.4},children:[h.jsxs(nd,{$color:b.gold,children:["1 in ",j($)]}),h.jsx(id,{children:"Your Odds"})]}),h.jsxs(ed,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{delay:.5},children:[h.jsxs(nd,{children:["#",n.currentDrawNumber]}),h.jsx(id,{children:"Draw Number"})]})]}),h.jsxs(KM,{children:[h.jsx(QM,{}),h.jsxs(ZM,{children:["You're in Pool #",a.currentPool]}),a.ticketMultiplier>1&&h.jsxs(FM,{children:[a.ticketMultiplier,"x Tickets"]})]})]})]})},JM=Tt`
  0%, 100% {
...
`,aD=T(I.div)`
  ...
  font-size: 12px;
  font-weight: 600;
`,rD=()=>{const{nextDraw:n,pool:a}=dn(),[o,l]=C.useState({days:0,hours:0,minutes:0,seconds:0}),[c,f]=C.useState(!1);C.useEffect(()=>{const p=()=>{const w=n-new Date;if(w>0){const j=Math.floor(w/864e5),$=Math.floor(w%(1e3*60*60*24)/(1e3*60*60)),D=Math.floor(w%(1e3*60*60)/(1e3*60)),L=Math.floor(w%(1e3*60)/1e3);l({days:j,hours:$,minutes:D,seconds:L})}};p();const v=setInterval(()=>{p(),f(x=>!x)},1e3);return()=>clearInterval(v)},[n]);const d=p=>p.toString().padStart(2,"0"),g=o.days===0&&o.hours<24;o.days*24+o.hours;const m=p=>p.toLocaleDateString("en-IE",{weekday:"short",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"});return h.jsxs(WM,{$urgent:g,initial:{opacity:0,x:20},animate:{opacity:1,x:0},transition:{duration:.5,delay:.3},children:[h.jsx(IM,{children:"Next Draw In"}),h.jsxs(tD,{children:[h.jsxs(cs,{children:[h.jsx(us,{$urgent:g,children:h.jsx("span",{children:d(o.days)})}),h.jsx(fs,{children:"Days"})]}),h.jsxs(cs,{children:[h.jsx(us,{$urgent:g,children:h.jsx("span",{children:d(o.hours)})}),h.jsx(fs,{children:"Hours"})]}),h.jsxs(cs,{children:[h.jsx(us,{$urgent:g,children:h.jsx("span",{children:d(o.minutes)})}),h.jsx(fs,{children:"Mins"})]}),h.jsxs(cs,{children:[h.jsx(us,{$urgent:g,children:h.jsx("span",{children:d(o.seconds)})}),h.jsx(fs,{children:"Secs"})]})]}),h.jsxs(eD,{children:[h.jsxs(nD,{children:["Draw #",a.currentDrawNumber]}),h.jsx(iD,{children:m(n)})]}),g&&h.jsx(aD,{initial:{opacity:0,scale:.9},animate:{opacity:1,scale:1},children:"Draw closing soon!"})]})},oD=Tt`
  0%, 100% {
...
`,hD=()=>h.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[h.jsx("path",{d:"M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"}),h.jsx("circle",{cx:"9",cy:"7",r:"4"}),h.jsx("path",{d:"M23 21v-2a4 4 0 0 0-3-3.87"}),h.jsx("path",{d:"M16 3.13a4 4 0 0 1 0 7.75"})]}),pD=()=>h.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[h.jsx("polyline",{points:"20 12 20 22 4 22 4 12"}),h.jsx("rect",{x:"2",y:"7",width:"20",height:"5"}),h.jsx("line",{x1:"12",y1:"22",x2:"12",y2:"7"}),h.jsx("path",{d:"M12 7H7.5a2.5 2.5 0 0 1 0-5C11 2 12 7 12 7z"}),h.jsx("path",{d:"M12 7h4.5a2.5 2.5 0 0 0 0-5C13 2 12 7 12 7z"})]}),mD=()=>h.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[h.jsx("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2",ry:"2"}),h.jsx("line",{x1:"9",y1:"9",x2:"15",y2:"15"}),h.jsx("line",{x1:"15",y1:"9",x2:"9",y2:"15"})]}),I1=()=>h.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[h.jsx("circle",{cx:"18",cy:"5",r:"3"}),h.jsx("circle",{cx:"6",cy:"12",r:"3"}),h.jsx("circle",{cx:"18",cy:"19",r:"3"}),h.jsx("line",{x1:"8.59",y1:"13.51",x2:"15.42",y2:"17.49"}),h.jsx("line",{x1:"15.41",y1:"6.51",x2:"8.59",y2:"10.49"})]}),tx=({isMobile:n=!1})=>{const{player:a,setSyndicateModalOpen:o,setGiftModalOpen:l,setMultiplierModalOpen:c,setInviteModalOpen:f}=dn(),[d,g]=C.useState(!1),m=a.ticketMultiplier>1;C.useEffect(()=>{const x=setTimeout(()=>{g(!0)},5e3);return()=>clearTimeout(x)},[]);const p=()=>{g(!1),f(!0)},v=[{label:"Start Syndicate",description:"Team up with friends",icon:h.jsx(hD,{}),onClick:()=>o(!0),variant:"secondary"},{label:"Gift Ticket",description:"Send to a friend",icon:h.jsx(pD,{}),onClick:()=>l(!0),variant:"secondary"},{label:"Multiplier",description:"Boost your odds",icon:h.jsx(mD,{}),onClick:()=>c(!0),variant:"primary"},{label:"Invite Friends",description:"Multiply your odds",icon:h.jsx(I1,{}),onClick:p,variant:"secondary"}];return n?h.jsx(sD,{children:v.map((x,w)=>{const $=x.label==="Multiplier"&&m;return h.jsx(cD,{$variant:x.variant,$active:$,onClick:x.onClick,whileTap:{scale:.95},initial:{opacity:0,y:10},animate:{opacity:1,y:0},transition:{delay:.1+w*.05},children:x.icon},x.label)})}):h.jsxs(lD,{children:[v.slice(0,3).map((x,w)=>{const j=x.label==="Multiplier",$=j&&m;return h.jsxs(Z1,{$variant:x.variant,$active:$,onClick:x.onClick,whileHover:{scale:1.02},whileTap:{scale:.98},initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{delay:.4+w*.1},children:[h.jsx(F1,{$variant:x.variant,$active:$,children:x.icon}),h.jsx(J1,{$active:$,children:$?"Multiplier Active":j?"Activate Multiplier":x.label}),h.jsx(W1,{$active:$,children:$?"Tap to change":x.description})]},x.label)}),h.jsxs(uD,{children:[h.jsx(en,{children:d&&h.jsxs(fD,{initial:{opacity:0,y:10,x:"-50%"},animate:{opacity:1,y:0,x:"-50%"},exit:{opacity:0,y:-10,x:"-50%"},onClick:p,children:["Increase Winning Chances by up to 10X NOW!",h.jsx(dD,{onClick:x=>{x.stopPropagation(),g(!1)},children:"✕"})]})}),h.jsxs(Z1,{$variant:"secondary",onClick:p,whileHover:{scale:1.02},whileTap:{scale:.98},initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{delay:.7},style:{flex:1},children:[h.jsx(F1,{$variant:"secondary",children:h.jsx(I1,{})}),h.jsx(J1,{children:"Invite Friends"}),h.jsx(W1,{children:"Multiply your odds"})]})]})]})},gD=T(I.div)`
  background: rgba(253, 249, 238, 0.03);
  border: 1px solid rgba(253, 249, 238, 0.08);
  border-radius: 16px;
  padding: 16px 20px;
...
`,MD=T.span`
  ...
  font-size: 11px;
  white-space: nowrap;
`,DD=()=>h.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[h.jsx("path",{d:"M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"}),h.jsx("circle",{cx:"8.5",cy:"7",r:"4"}),h.jsx("line",{x1:"20",y1:"8",x2:"20",y2:"14"}),h.jsx("line",{x1:"23",y1:"11",x2:"17",y2:"11"})]}),ex=()=>h.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[h.jsx("circle",{cx:"12",cy:"12",r:"10"}),h.jsx("polyline",{points:"12 6 12 12 16 14"})]}),$D=()=>h.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[h.jsx("polyline",{points:"20 12 20 22 4 22 4 12"}),h.jsx("rect",{x:"2",y:"7",width:"20",height:"5"}),h.jsx("line",{x1:"12",y1:"22",x2:"12",y2:"7"}),h.jsx("path",{d:"M12 7H7.5a2.5 2.5 0 0 1 0-5C11 2 12 7 12 7z"})]}),zD=()=>h.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[h.jsx("circle",{cx:"12",cy:"8",r:"7"}),h.jsx("polyline",{points:"8.21 13.89 7 23 12 20 17 23 15.79 13.88"})]}),RD=n=>{switch(n){case"join":return h.jsx(DD,{});case"draw":return h.jsx(ex,{});case"gift":return h.jsx($D,{});case"win":return h.jsx(zD,{});default:return h.jsx(ex,{})}},ad=[{icon:"💬",text:"New message from Sarah!"},{icon:"🎉",text:"James just won €250!"},{icon:"🎁",text:"Emma gifted you a ticket!"},{icon:"👥",text:"Mike invited you to a syndicate!"},{icon:"💰",text:"Lisa won the weekly draw!"},{icon:"🎫",text:"Tom sent you a bonus ticket!"},{icon:"🏆",text:"Your syndicate won €500!"},{icon:"📩",text:"You have 3 unread messages"}],OD=()=>{const{activity:n}=dn(),[a,o]=C.useState([]),[l,c]=C.useState(0);C.useEffect(()=>{const g=setTimeout(()=>{o([{...ad[0],id:Date.now()}])},5e3);return()=>clearTimeout(g)},[]),C.useEffect(()=>{const g=setInterval(()=>{const m=(l+1)%ad.length;c(m),o(p=>[{...ad[m],id:Date.now()},...p])},15e3);return()=>clearInterval(g)},[l]);const f=a.length>0?a[0].id:null,d=[...a.map(g=>({...g,type:"notification",time:"Just now"})),...n].slice(0,6);return h.jsxs(gD,{initial:{opacity:0,y:10},animate:{opacity:1,y:0},transition:{delay:.6},children:[h.jsx(wD,{children:"Recent Activity"}),h.jsx(TD,{children:h.jsx(en,{initial:!1,children:d.map((g,m)=>{const p=g.type==="notification"&&g.id===f;return g.type==="notification"?h.jsxs(yD,{$isNew:p,initial:{opacity:0,height:0},animate:{opacity:1,height:"auto"},exit:{opacity:0,height:0},transition:{type:"spring",stiffness:300,damping:25},layout:!0,children:[h.jsx(xD,{$isNew:p,children:g.icon}),h.jsx(vD,{children:h.jsx(bD,{$isNew:p,children:g.text})}),h.jsx(SD,{$isNew:p,children:g.time})]},g.id):h.jsxs(CD,{initial:{opacity:0,x:-10},animate:{opacity:1,x:0},transition:{delay:m*.05},layout:!0,children:[h.jsx(jD,{$type:g.type,children:RD(g.type)}),h.jsx(ED,{children:h.jsx(AD,{children:g.text})}),h.jsx(MD,{children:g.time})]},g.id)})})})]})},Qs=T(I.div)`
  position: fixed;
  inset: 0;
  background: rgba(21, 1, 0, 0.85);
...
`,g$=()=>h.jsxs(ID,{children:[h.jsx(nM,{}),h.jsxs(t$,{children:[h.jsx(y$,{}),h.jsx(h$,{children:h.jsx(Q1,{})}),h.jsx(p$,{children:h.jsx(tx,{isMobile:!0})}),h.jsxs(e$,{children:[h.jsx(n$,{children:h.jsx($M,{})}),h.jsx(i$,{children:h.jsx(Q1,{})}),h.jsx(a$,{children:h.jsx(m$,{children:h.jsx(rD,{})})})]}),h.jsxs(r$,{children:[h.jsx(o$,{children:h.jsx(tx,{})}),h.jsx(l$,{children:h.jsx(OD,{})})]})]}),h.jsx(ZD,{}),h.jsx(FD,{}),h.jsx(JD,{}),h.jsx(WD,{})]}),y$=()=>{const{player:n,pool:a}=dn(),[o,l]=C.useState({hours:0,minutes:0,seconds:0});C.useEffect(()=>{const f=new Date;f.setDate(f.getDate()+2),f.setHours(20,0,0,0);const d=()=>{const p=f-new Date;if(p>0){const v=Math.floor(p/36e5),x=Math.floor(p%(1e3*60*60)/(1e3*60)),w=Math.floor(p%(1e3*60)/1e3);l({hours:v,minutes:x,seconds:w})}};d();const g=setInterval(d,1e3);return()=>clearInterval(g)},[]);const c=f=>f.toString().padStart(2,"0");return h.jsxs(s$,{children:[h.jsx(c$,{src:n.avatar,alt:n.username}),h.jsxs(u$,{children:[h.jsx(f$,{children:"Next Draw"}),h.jsxs(d$,{children:[c(o.hours),":",c(o.minutes),":",c(o.seconds)]})]})]})},x$=()=>h.jsx(XA,{children:h.jsx(g$,{})}),v$=()=>h.jsxs(h.Fragment,{children:[h.jsx(rE,{}),h.jsxs("main",{children:[h.jsx(OE,{}),h.jsx(qE,{}),h.jsx(i8,{}),h.jsx(b8,{}),h.jsx(U8,{}),h.jsx(oA,{}),h.jsx(TA,{})]}),h.jsx(NA,{}),h.jsx(_A,{}),h.jsx(UA,{}),h.jsx(HA,{})]});function b$(){return h.jsx(W3,{basename:"/moneypools-landing",children:h.jsxs(u5,{children:[h.jsx(dT,{}),h.jsxs(M3,{children:[h.jsx(ld,{path:"/",element:h.jsx(v$,{})}),h.jsx(ld,{path:"/dashboard",element:h.jsx(x$,{})})]})]})})}zw.createRoot(document.getElementById("root")).render(h.jsx(C.StrictMode,{children:h.jsx(b$,{})}));
